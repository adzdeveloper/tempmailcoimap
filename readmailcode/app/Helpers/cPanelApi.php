...
class cPanelApi {
    ...
    public function addForwarder($usermail, $emailfwd,$mail_domain) {

    $func = "https://$this->cPanelUrl:$this->cPanelPort/execute/Email/add_forwarder?domain=$mail_domain&email=$usermail&fwdopt=fwd&fwdemail=$emailfwd";
    \Log::info('This is some useful information.'.$func);
    return $this->exe_cpanel($func);
